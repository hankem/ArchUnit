...
public class CyclicDependencyRulesTest {
    ...
    public void no_cycles_by_method_calls_between_slices() {
        freeze(slices().matching("..(simplecycle).(*)..").namingSlices("$2 of $1")
    ...
    public void no_cycles_by_constructor_calls_between_slices() {
        freeze(slices().matching("..(constructorcycle).(*)..").namingSlices("$2 of $1")
                .should().beFreeOfCycles())
                .check(classes);
    }
    ...
    public void no_cycles_by_inheritance_between_slices() {
        freeze(slices().matching("..(inheritancecycle).(*)..").namingSlices("$2 of $1")
                .should().beFreeOfCycles())
                .check(classes);
    }
    ...
    public void no_cycles_by_field_access_between_slices() {
        freeze(slices().matching("..(fieldaccesscycle).(*)..").namingSlices("$2 of $1")
                .should().beFreeOfCycles())
                .check(classes);
    }
    ...
    public void no_cycles_by_member_dependencies_between_slices() {
        freeze(slices().matching("..(membercycle).(*)..").namingSlices("$2 of $1")
                .should().beFreeOfCycles())
                .check(classes);
    }
    ...
    public void no_cycles_in_simple_scenario() {
        freeze(slices().matching("..simplescenario.(*)..").namingSlices("$1")
                .should().beFreeOfCycles())
                .check(classes);
    }
    ...
    public void no_cycles_in_complex_scenario() {
        freeze(slices().matching("..(complexcycles).(*)..").namingSlices("$2 of $1")
                .should().beFreeOfCycles())
                .check(classes);
    }
    ...
    public void no_cycles_in_freely_customized_slices() {
        freeze(slices().assignedFrom(inComplexSliceOneOrTwo())
                .namingSlices("$1[$2]")
                .should().beFreeOfCycles())
                .check(classes);
    }
